...
// Declare the class and members here, and define them in hw7.shark.cpp.
class Shark : public Fish {
   public:
    ...
    // (2 points)
    // In Fish class, change Grow(), Print() and Reproduce() to virtual
    // functions and also add Eat() as a virtual function in Fish. Fish::Eat()
    // does nothing. so that the following code calls Shark::Print():
    //   Fish* fptr = new Shark;
    //   fptr->Print();
