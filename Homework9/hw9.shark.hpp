...
#include <vector>
#include "hw9.fish.hpp"
using namespace std;
// The class Shark inherits from Fish.
...
// A new member function of the Shark class:
//   void Eat(std::vector<Fish*> fish_in_cell);
// When this function is called, eat as much Fish as necessary to satisfy hunger.
// For example, if the shark's hunger is 7, and there are four fish whose sizes are
// 2, 4, 2, 5,
...
// Another example, suppose the shark's hunger is 7, and there are two fish whose 
// sizes are 2, 3,
// then both fish would be eaten, and the shark's new hunger value is 7 - 2 - 3 = 
// 5.
